                                    ...
                                    <form action="PurchaseRuby" method="post"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                       class="form-control"
                                                       value="NGUYEN VAN A - 0123456789" readonly >
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="10" max="10000"
                                                       ...
                                                       name="rubyInput"
                                                       placeholder="Amount of ruby (1 Ruby = 1000 vnđ)" onchange="calculateMoney(this.value)" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                       ...
                                                       placeholder="phone number used to pay" required>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                       ...
                                                       class="form-control"
                                                       placeholder="Trading code" required>
                                            </div>
